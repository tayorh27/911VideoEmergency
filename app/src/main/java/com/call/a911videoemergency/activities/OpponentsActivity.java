...
public class OpponentsActivity extends BaseActivity {
    ...
    private void startLoadUsers() {
        ...
        String currentRoomName = new AppData(OpponentsActivity.this).getCountry();
